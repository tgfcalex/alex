...
# 取yml內image版本
api=`cat $path/H-api.yml | grep hub.chats-boss.com/im/* | awk -F ':' '{print $3}'`
admin=`cat $path/H-admin.yml | grep hub.chats-boss.com/im/* | awk -F ':' '{print $3}'`
chatbot=`cat $path/H-chatbot.yml | grep hub.chats-boss.com/im/* | awk '{print $2}' | awk -F ':' '{print $2}'`
file=`cat $path/H-file.yml | grep hub.chats-boss.com/im/* | awk '{print $2}' | awk -F ':' '{print $2}'`
gateway=`cat $path/H-gateway.yml | grep hub.chats-boss.com/im/* | awk '{print $2}' | awk -F ':' '{print $2}'`
push=`cat $path/H-push.yml | grep hub.chats-boss.com/im/* | awk '{print $2}' | awk -F ':' '{print $2}'`
robot=`cat $path/H-robot.yml | grep hub.chats-boss.com/im/* | awk '{print $2}' | awk -F ':' '{print $2}'`
server=`cat $path/H-server.yml | grep hub.chats-boss.com/im/* | awk '{print $2}' | awk -F ':' '{print $2}'`
services=`cat $path/H-services.yml | grep hub.chats-boss.com/im/* | awk '{print $2}' | awk -F ':' '{print $2}'`
smarttalk=`cat $path/H-smarttalk.yml | grep hub.chats-boss.com/im/* | awk '{print $2}' | awk -F ':' '{print $2}'`
task=`cat $path/H-task.yml | grep hub.chats-boss.com/im/* | awk '{print $2}' | awk -F ':' '{print $2}'`
user=`cat $path/H-user.yml | grep hub.chats-boss.com/im/* | awk '{print $2}' | awk -F ':' '{print $2}'`
webdownload=`cat $path/H-web-download.yml | grep hub.chats-boss.com/im/* | awk '{print $2}' | awk -F ':' '{print $2}'`
website=`cat $path/H-website.yml | grep hub.chats-boss.com/im/* | awk '{print $2}' | awk -F ':' '{print $2}'`
websmarttalk=`cat $path/H-web-smarttalk.yml | grep hub.chats-boss.com/im/* | awk '{print $2}' | awk -F ':' '{print $2}'`
# 取運行中服務的image版號-1
