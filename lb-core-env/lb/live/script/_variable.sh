...
# 共用脚本目录
exp_script_dir='/var/env/common/script/release/'
# 控制机工程目录
base_path='/var/env'
# 实际应用目录
...
project="lb"
# 完整包的源路径
latest_app_dir="${base_path}/apps/${project}/work"
dist_app_dir="/var/lb/apps"
bak_app_dir="/var/env/apps/bak_apps"
...
# ----------------------------------------------------- 替换配置 for conf.sh
# fserver
filesite_url='http://lb-fserver:80/fserver'
...
freemaker_template_root_path=http://lb-fserver:80/ftl/
